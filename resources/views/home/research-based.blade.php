            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <section class="html-content">
                        ...
                        <p>
                        The development of <em>Next Gen PET</em> and its predecessor curricula was guided by five design principles based on research on learning. The following table shows how the design principles are put into action in <em>Next Gen PET</em>.
                        </p>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><strong>3. Learning is facilitated through interaction with tools.</strong></td>
                                ...
                                <tr>
                                    <td><strong>4. Learning is facilitated through interactions with others</strong></td>
                                ...
                                <tr>
                                    <td><strong>5. Learning is facilitated through establishment of certain specific behavioral practices and expectations.</strong></td>
