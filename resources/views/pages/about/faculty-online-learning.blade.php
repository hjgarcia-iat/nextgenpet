...
@section('content')
    ...
    <p>
        <a href="http://ngpfolc.com/" target="_blank">Learn more</a> about the Next Gen PET FOLC or
        complete an
        <a href="https://goo.gl/forms/te8scHzsad8aRCl43" target="_blank">application
        </a>.
    </p>
