...
@section('content')
    ...
    <p>
        ...
        and discussing their ideas both within their group and with the class. </p>
    <p>
    ...
    <p>
        ...
        students do experiments requiring simple materials on their desktops, but for more extensive experiments, they
        watch videos; (2) students respond to questions (using handheld response devices [e.g., “clickers”] or smart
        phones) to share ideas with the whole class; and (3) the instructor manages the class time through a set of
        PowerPoint slides that align with the student materials. </p>
