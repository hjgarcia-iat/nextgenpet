...
@section('content')
    ...
    <p>
        ...
        is available in a
        <em>Studio-style</em>
        class version for small lab and discussion classroom environments of 12-36 students; and a
        <em>Lecture-style</em>
        class version for lecture-style classrooms. In both versions, students draw on evidence, discuss ideas, develop, test and modify models, and engage in practices of scientific argumentation.
    </p>
    <p>
        The
        <em>Studio-style</em>
    ...
    <p>
        The
        <em>Lecture-style</em>
        class (LC) version is best suited for courses that meet ~2.5 hours/week in lecture-style classrooms where students have desktops on which they can work. The LC version is suitable for courses with large enrollments, or in courses with smaller enrollments with limited meeting time and facilities. The content and pedagogical approach is similar to the SC version, but in the LC version: (1) students can do experiments requiring simple materials on their desktops as an option, but otherwise and for more extensive experiments, they watch videos; (2) students respond to questions (using hand-held response devices [e.g., “clickers”] or smart phones) to share ideas with the whole class; and (3) the instructor manages the class time through a set of PowerPoint™ slides that align with the student materials.
    </p>
    <p>
    ...
    <table class="table table-bordered table-hover table-responsive">
        ...
        <tr>
            ...
            <td>Big ideas/science practices (e.g. writing explanations) developed within & across units. A variety of question types guide students’ thinking. Extensions (homework) are computer-based tutorials that include online quizzes
            </td>
            <td>Similar to SC, except students do not write their own explanations; instead they evaluate carefully crafted explanations for accuracy. Extensions are the same as SC.
            </td>
        </tr>
        <tr>
            <td>3. Learning is facilitated through interaction with tools.</td>
            <td>Students use hands-on materials, data acquisition tools and simulations, and answer questions on activity sheets.
            </td>
            <td>Students watch videos of experiments, demos and simulations, do simple hands-on activities (optional); answer questions with ‘clickers’ and on lesson sheets
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>5. Learning is facilitated through establishment of certain specific behavioral practices and expectations.
            </td>
            <td>Written prompts/instructor comments support expectations of providing evidence, active participation, and responsibility for learning.
            </td>
            <td>Similar to SC except the degree of participation is less and students are expected to reach consensus at end of each lesson.
            </td>
        </tr>
        </tbody>
    </table>
