...
@section('content')
    <section class="html-content">
        ...
        <em>Lecture-style</em> class version for lecture-style classrooms. In both versions, students draw on evidence, discuss ideas, develop, test and modify models, and engage in practices of scientific argumentation.
        </p>
        <p>
        The
