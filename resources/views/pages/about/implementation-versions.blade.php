...
@section('content')
    ...
    <img src="{{ url('img/content/imp-version-1.png') }}"
         alt="Implementation Versions"
    ...
    <img src="{{ url('img/content/imp-version-2.png') }}"
         alt="Implementation Versions"
         class="d-block mx-auto img-responsive img-thumbnail mb-2">
    <p>
        ...
        <strong>Developing Model of Magnetism</strong>
        ,
        <strong>Interactions and Forces</strong>
        . See also the
        <strong>Design Principles</strong>
        section of this website for a table summarizing the differences in how each version implements the design features of the curriculum.
    </p>
