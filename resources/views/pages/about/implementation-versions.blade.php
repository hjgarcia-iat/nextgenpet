...
@section('content')
    ...
    <p>
        ...
        engage in practices of scientific argumentation. </p>
    <p>
        ...
        within their group and with the whole class. </p>
    <img src="{{ url('img/content/imp-version-1.png') }}" alt="Implementation Versions" class="d-block mx-auto img-responsive img-thumbnail mb-2">
    <p>
        ...
        (2) students respond to questions (using hand-held response devices [e.g., “clickers”] or smart phones) to share
        ideas with the whole class; and (3) the instructor manages the class time through a set of PowerPoint™ slides
        that align with the student materials. </p>
    <img src="{{ url('img/content/imp-version-2.png') }}" alt="Implementation Versions" class="d-block mx-auto img-responsive img-thumbnail mb-2">
    <p>
        The table below summarizes the differences between structural features of the two versions. To see examples of
        both versions, click on one of the links below: <strong>Developing Model of Magnetism</strong>, <strong>Interactions
            and Forces</strong>. See also the <strong>Design Principles</strong> section of this website for a table
        summarizing the differences in how each version implements the design features of the curriculum. </p>
    ...
    <p>
        ...
        class versions of <em>Next Gen PET</em> . </p>
    <table class="table table-bordered table-hover table-responsive">
        <thead>
        <tr>
