...
@section('content')
    ...
    <section class="html-content">
        <p>
            <em>Next Gen PET</em>
            consists of five modules: (1) Module MSE: Developing Models for Magnetism and Static Electricity; (2) Module IE: Interactions and Energy; (3) Module IF: Interactions and Forces; (4) Module WSL: Waves, Sound and Light; and (5) Module MI: Matter and Interactions. Each module includes one or two engineering design activities requiring application of the module’s physical science content.
        </p>
        <p>
            <em>Next Gen PET</em>
            also includes
            <em>Teaching and Learning activities</em>
            to help students make explicit connections between their own learning; the learning and teaching of children in elementary school; and the core ideas, science and engineering practices, and crosscutting concepts of the NGSS.
        </p>
        <p>
            Each module has two versions, one for small, studio-style classes that are able to accommodate extensive laboratory work and discussion, and one for lecture-style classes. Both versions use the same extensive set of online tutorial-style homework assignments, called
            <em>Extensions</em>
            .
        </p>
        <p>
            ...
            <em>Teaching and Learning activities</em>
            , and which instructional format to use. This allows instructors to tailor their course to match their content focus, meeting time, classroom setting, and students’ interests.
        </p>
        <p>
        ...
        <h3>Module MSE</h3>
        <p>
            Module MSE focuses on developing models for magnetism and static electricity. In the first unit, students iteratively propose, test, and revise models for magnetism. They ultimately arrive at the "alignment model," which can explain all the class observations (the alignment model is similar to the domain model, but simpler). The second unit engages students in a similar process for static electric phenomena. Developing these explanatory models engages students in several practices of the Next Generation Science Standards, notably developing and using models, and promotes the crosscutting concept
