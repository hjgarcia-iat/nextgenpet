...
@section('content')
<p>
    Teaching and Learning activities help
    <em>
        Next Gen PET
    </em>
...
<p>
    ...
    ,as well as copies of the student materials that you can freely download for your own classes
    , see the
    <a href="/studio-style-class">
        Studio-style Class
    </a>
    or
    <a href="/lecture-style-class">
        Lecture-style Class
    </a>
    pages, under "Teaching and Learning Materials" on the left-side menu. For more information on using Teaching and Learning activities, click on "Learn More" below.
</p>
<p>
    <a class="btn btn-primary btn-reveal" href="">
        Learn More…
    </a>
</p>
<div class="reveal">
    ...
    <p>
        <em>
            Options for Using Teaching and Learning Activities
        </em>
    </p>
    <p>
