...
@section('content')
    ...
    <p>
        The development of
        <em>Next Gen PET</em>
        and its predecessor curricula was guided by five design principles based on research on learning. The following table shows how the design principles are put into action in
        <em>Next Gen PET</em>
        .
    </p>
