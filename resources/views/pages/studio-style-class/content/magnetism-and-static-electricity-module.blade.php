...
@section('content')
    ...
    <section id="html-content" class="html-content">
        ...
        <p>The main purpose of this module is to engage students in several science and engineering practices, particularly developing and using models, constructing explanations, and engaging in argument from evidence.  The explanatory models students develop are mechanistic, so students get extensive experience with the crosscutting concept of <em>Cause and Effect: Mechanism and Explanation</em>.   As students engage in the practices, what emerges is an understanding of magnetic interactions, which is part of the core physical science idea <em>PS2B, Types of Interactions</em>.
        </p>
        <p>
        ...
        <div class="canvas-header">Click on an activity or extension to see an overview below the unit trajectory.</div>
