...
@section('content')
    ...
    <section id="html-content" class="html-content">
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
            <tr class="highlight">
                <td colspan="3" class="text-center">Magnetism and Static Electricity Module
                </td>
            </tr>
            <tr>
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
            <tr class="highlight">
                <td colspan="3" class="text-center">Interactions and Energy Module
                </td>
            </tr>
            <tr>
                <td colspan="3" class="text-center">
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
            <tr class="highlight">
                <td colspan="3" class="text-center">Interactions and Forces Module
                </td>
            </tr>
            <tr>
                <td colspan="3" class="text-center">
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
            <tr class="highlight">
                <td colspan="3" class="text-center">Waves, Sound and Light Module
                </td>
            </tr>
            <tr>
                <td colspan="3" class="text-center">
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
            <tr class="highlight">
                <td colspan="3" class="text-center">Matter and Interactions Module
                </td>
            </tr>
            <tr>
                <td colspan="3" class="text-center">
