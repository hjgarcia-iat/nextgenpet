...
@section('content')
    ...
    <section id="html-content" class="html-content">
        ...
        <p>Each Teaching and Learning activity and extension in the Module MI (Matter and Interactions) cluster is
        ...
        <p>Note that Extension O is a group project involving working with children. This project typically takes 2-3
            ...
            done with the project, the class will (probably) be on a different unit. Thus, the follow-up Activity 11,
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tr>
                <td></td>
                <td colspan="6">This extension includes a video analysis of videos of elementary school children
                    deciding on criteria for good quality play dough and communicating ideas about how to make play
                    dough. It also introduces Practice 8, obtaining, evaluating and communicating information.
                </td>
            </tr>
            <tr>
                <td></td>
                <td colspan="6">
                    <strong>Assign</strong>: After Unit PC A5, before TL A10.
                </td>
            </tr>
            <tr class="highlight">
                <td>A10</td>
                <td class="cell-link">
                    <a href="https://s3.amazonaws.com/nextgenpet/web-docs/teaching-and-learning/studio/Module_MI_Cluster/TL_Activity_10.pdf" target="_blank">Obtaining,
            ...
            <tr>
                <td></td>
                <td colspan="6">Next Gen PET students focus on NGSS Practice 8 (obtaining, evaluating, and
                    communicating, information). They reflect how they engaged in this practice in Next Gen PET and how
                    children engaged in this practice, and the ways that teachers facilitate children’s engagement in
                    this practice. This also prepares them for the lesson they will facilitate as part of Ext O.
                </td>
            </tr>
            <tr>
                <td></td>
                <td colspan="6">
                    <strong>In class</strong>: After Unit PC A5 and TL Ext N.
                </td>
            </tr>
            <tr class="highlight">
                <td>Ext O</td>
            ...
            <tr>
                <td></td>
                <td colspan="6">
                    <strong>Assign</strong>: After TL Ext C, TL A10 and near the end of Unit PC.
                </td>
            </tr>
            <tr class="highlight">
                <td>A11</td>
                <td class="cell-link">
                    <a href="https://s3.amazonaws.com/nextgenpet/web-docs/teaching-and-learning/studio/Module_MI_Cluster/TL_Activity_11.pdf" target="_blank">Creating
