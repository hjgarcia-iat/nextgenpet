...
<section class="html-content" id="html-content">
    <h3>
        Interactions and Forces Module - Teaching &amp; Learning
    </h3>
    ...
    <p>Note that Extension I is a group project involving working with children. This project typically takes 2-3 weeks from initial assignment to the time the final individual and group reports are turned in. Although the physical science content (forces on a parachute) is associated with Unit CF, by the time students are done with the project, the class will (probably) be on a different unit. Thus, the follow-up Activity 6, where students reflect on their interactions with the children they interviewed, will not be connected to your current unit.</p>
    <table class="table table-bordered table-hover table-sm table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="6">Next Gen PET students analyze a video in which children conduct experiments to assess how three variables affect parachute speed, paying attention to the student and teacher actions. This is reflected on in TL A5 and Next Gen PET students facilitate a similar lesson in Ext I. This extension also includes the table of grade level competencies for carrying out investigations.  </td>
            </tr>
            <tr>
                <td>
                </td>
            ...
            <tr>
                ...
                <td colspan="6">Short reading about common ideas that children and adults have about force and motion. </td>
            </tr>
            <tr>
                <td>
                </td>
            ...
            <tr>
                ...
                <td colspan="6">In class discussion and reflection on the interviews with children that the Next Gen PET students conducted as part of Ext I. Students then look at NGSS Practices 1, 3, and 4 (asking questions, planning and carrying out investigations, analyzing and interpreting data) and reflect on where their own instruction in Ext I fell on the learner directed/teacher directed continuum in the context of these practices. Finally, they consider how the parachute activity helped develop children’s understanding of scientific content.</td>
            </tr>
            <tr>
                <td>
                </td>
