    ...
    <section id="html-content"
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td colspan="6">This extension includes video analysis of a video of elementary school children conducting an experiment about light.  It also introduces the grade level competencies for NGSS Practice 6, constructing explanations and designing solutions. </td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="6">
                ...
                <tr>
                    <td></td>
                    <td colspan="6">Focuses on NGSS Practice 6 (constructing explanations and designing solutions). Next Gen PET students focus on their own explanations related to light and sound phenomena. They then discuss a video (watched in Ext K) of children engaging in Practice 6 related to a science experiment with light. Finally, they consider how they might facilitate children’s participation in Practice 6 through activities related to sound and light that they will facilitate in Ext L. </td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="6">
                        <strong>In class</strong>: After Unit L L2/A2 and TL Ext K. [Having worked through the UWS lesson/activity on sound waves (A2) would be helpful, but not necessary.]
                    </td>
                </tr>
                <tr class="highlight">
                    <td>Ext L</td>
                ...
                <tr>
                    <td></td>
                    <td colspan="6">Next Gen PET students facilitate an activity where the children either construct an explanation/design and carry out an investigation around shadows, or design a solution to a problem using light and sound.  They collaborate with group members to write a report synthesizing their interview results.</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="6">
                ...
                <tr>
                    <td></td>
                    <td colspan="6">This extension includes analysis of a video of elementary school children designing solutions to an engineering design challenge related to light.  It also introduces the grade level competencies for NGSS Practice 8, engaging in argument from evidence.</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="6">
