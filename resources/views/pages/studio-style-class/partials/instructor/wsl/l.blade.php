        ...
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    ...
                    <a target="_blank" href="http://public.csusm.edu/NextGenPET/Extensions/L/ExtA/index.html">Extension Online (HTML5)
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    ...
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//movies/movies_wsl/movies_wsl_ul_a2.html">Demonstration Movies </a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour">
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    <i class="fa-li fa fa-globe"></i>
                    <a target="_blank" href="http://public.csusm.edu/NextGenPET/Extensions/L/ExtB/index.html">Extension Online (HTML5)
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div id="collapseSeven" class="collapse" role="tabpanel" aria-labelledby="headingSeven">
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//movies/movies_wsl/movies_wsl_ul_a5.html">Demonstration Movie</a>
                </li>
            </ul>
        </div>
    </div>
