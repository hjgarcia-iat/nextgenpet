...
@section('content')
    ...
    <section id="html-content" class="html-content">
        ...
        <p><em>Next Gen PET</em> includes extensions (homework) to support the in-class activities and lessons.
        ...
        <p>
            ...
            you may include them directly on the course webpage. </p>
        <p>
        ...
        <ul class="fa-ul">
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank" href="http://nextgenpet.sdsu.edu/extensions/extensions_index_studio_mse.html">Magnetism
                    and Static Electricity Module</a></li>
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank" href="http://nextgenpet.sdsu.edu/extensions/extensions_index_studio_ie.html">Interactions
                    and Energy Module</a></li>
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank" href="http://nextgenpet.sdsu.edu/extensions/extensions_index_studio_if.html">Interactions
                    and Forces Module</a></li>
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank" href="http://nextgenpet.sdsu.edu/extensions/extensions_index_studio_wsl.html">Waves,
                    Sound and Light Module</a></li>
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank" href="http://nextgenpet.sdsu.edu/extensions/extensions_index_studio_mi.html">Matter
        ...
        <p>
            <strong>Note on Teaching and Learning (TL) extensions: </strong>: TL extensions include some extensions that
            are similar to the content extensions. A few are readings (available as PDFs). The remaining TL extensions
            involve both readings and some additional work outside of class, largely group work with other students. The
            TL extensions also come an assortment of quiz questions to be completed in the LMS like the content
            extension quizzes. </p>
        <p>
            ...
            Studio-Style Class version of NGP, you will find that some letters are missing in the list of extensions.
