    ...
    <section id="html-content" class="html-content">
        ...
        <ul class="fa-ul">
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank"
                   href="http://nextgenpet.sdsu.edu/movies/index_lc_mse.html">Magnetism and Static Electricity Module
                </a>
            </li>
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank"
                   href="http://nextgenpet.sdsu.edu/movies/index_lc_ie.html">Interactions and Energy Module
                </a>
            </li>
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank"
                   href="http://nextgenpet.sdsu.edu/movies/index_lc_if.html">Interactions and Forces Module
                </a>
            </li>
            <li><i class="fa-li fa fa-html5"></i>
                <a target="_blank"
                   href="http://nextgenpet.sdsu.edu/movies/index_lc_wsl.html">Waves, Sound and Light Module
                </a>
            </li>
