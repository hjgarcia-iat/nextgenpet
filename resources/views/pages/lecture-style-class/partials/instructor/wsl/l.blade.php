        ...
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    ...
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//movies/movies_wsl/movies_wsl_ul_l1.html">Demonstration Movies</a>
                </li>
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//videos/movies_wsl/movies_wsl_ul_l1.html">Classroom Video Clips</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree">
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//movies/movies_wsl/movies_wsl_ul_l2.html">Demonstration Movies</a>
                </li>
                <li>
                    <i class="fa-li fa fa-globe"></i>
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//videos/movies_wsl/movies_wsl_ul_l2.html">Classroom Video Clips</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive">
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//movies/movies_wsl/movies_wsl_ul_l3.html">Demonstration Movies</a>
                </li>
                <li>
                    <i class="fa-li fa fa-globe"></i>
                    <a target="_blank" href="https://phet.colorado.edu/en/simulation/bending-light">Bending Light Simulation</a>
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//videos/movies_wsl/movies_wsl_ul_l3.html">Classroom Video Clips</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="collapseSix" class="collapse" role="tabpanel" aria-labelledby="headingSix">
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//movies/movies_wsl/movies_wsl_ul_l4.html">Demonstration Movies</a>
                </li>
                <li>
                    <i class="fa-li fa fa-globe"></i>
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//videos/movies_wsl/movies_wsl_ul_l4.html">Classroom Video Clips</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="collapseSeven" class="collapse" role="tabpanel" aria-labelledby="headingSeven">
        <div class="card-block">
            <ul class="fa fa-ul">
                ...
                <li>
                    <i class="fa-li fa fa-file-video-o"></i>
                    <a target="_blank" href="http://nextgenpetstudent.activatelearning.com//videos/movies_wsl/movies_wsl_ul_l5.html">Classroom Video Clips</a>
                </li>
            </ul>
        </div>
    </div>
