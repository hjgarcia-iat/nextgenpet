        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td colspan="6">
                        <strong>Assign</strong>: After TL Ext C, TL L5,  Unit CF L4 and Unit FM L6 (focusing on the gravitational force).
                    </td>
                </tr>
                <tr class="highlight">
                    <td>Ext J</td>
                ...
                <tr>
                    <td></td>
                    <td colspan="6">
                        <strong>In class</strong>: After students complete all reports associated with Ext I children’s interview task.
                    </td>
                </tr>
            </tbody>
        </table>
