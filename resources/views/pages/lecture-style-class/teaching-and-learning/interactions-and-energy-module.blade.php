...
@section('content')
    ...
    <section id="html-content" class="html-content">
        ...
        <h3>Interactions and Energy Module - Teaching &amp; Learning</h3>
        <p>
        ...
        <p>
            Note that Extension G is a group project involving the interviewing of children. This project typically takes 2-3 weeks from initial assignment to the time the final individual and group reports are turned in. Although the physical science content (energy) is associated with Unit EM, by the time students are done with the project, the class will (probably) be on a different unit. Thus, the follow-up Lesson 4, where students reflect on their interactions with the children they interviewed, will not be connected to your current unit.
        </p>
        ...
        <table class="table table-bordered table-hover table-sm table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td colspan="6">
                        This extension prepares students for in class Lesson/Activity 3. Students watch and take notes on a short (7 min) EiE video in which elementary school teachers address issues that arise in their classrooms around data collection. They then read about NGSS Practices 1 (asking questions for science and defining problems for engineering) and 4 (analyzing and interpreting data).
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="6">
                        <strong>In class</strong>: After TL Ext F. In Unit EM, after L5. The content is general enough to be assigned during a different unit if you don’t do Unit EM.
                    </td>
                </tr>
                <tr class="highlight">
                    <td>Ext G</td>
                ...
                <tr>
                    <td></td>
                    <td colspan="6">
                        <strong>In class</strong>: After students complete all reports associated with Ext G children’s interview task.
                    </td>
                </tr>
            </tbody>
        </table>
