        ...
        <div class="container">
            ...
            <div class="row">
                <section class="media-block">
                    ...
                    <div class="col-xs-6 col-md-2">
                        ...
                        <h4 class="text-center">
                            <a href="https://petcyberpd.iat.com/introduction/General_Information/NGSS_&_Next_Gen_PET.pdf"
                               target="_blank">NGSS &amp; NextGEN PET</a>
                        </h4>
                    </div>
                    <div class="col-xs-6 col-md-2">
                        <a href="https://petcyberpd.iat.com/introduction/Curriculum/Learning_Objectives.pdf"
                           target="_blank"><img src="{{ asset('img/learning-objectives.jpg') }}" alt="NextGEN PET"
            ...
            <div class="row">
                <section class="media-block">
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('img/authors/3be527_029b5ba5efb7435790ec0bb8baadfd0a-mv2.jpg') }}"
                             alt="Fred Goldberg"
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('img/authors/3be527_a29f8de3f123464e8723e9f8a7e8445e-mv2.jpg') }}"
                             alt="Steve Robinson"
                             class="img-responsive img-circle center-block img-thumbnail">
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('img/authors/3be527_f7e79116c0a2461b9c80f49b94988693-mv2.jpg') }}"
                             alt="Danielle Harlow"
                             class="img-responsive img-circle center-block img-thumbnail">
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('img/authors/3be527_7fe2ca6526474fd19c7138ade349fed8-mv2.jpg') }}"
                             alt="Michael McKean"
                             class="img-responsive img-circle center-block img-thumbnail">
