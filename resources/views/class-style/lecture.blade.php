    ...
    <body>
        ...
        <div class="navmenu navmenu-default navmenu-fixed-left offcanvas-lg" style="">
            ...
            <ul class="nav navmenu-nav">
                ...
                <li class="divider"></li>
                <li class="sidebar-menu-link{{ (Request::is('lecture-style-class')) ? ' active' : '' }}">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <section id="html-content" class="html-content">
                        ...
                        <p>
                        The
                        <em>Predictions, Observations and Making Sense</em> (POM) section includes three parts; Part 1 addresses the
                        <em>Key Question</em> on brief pushes. Students first watch a movie of a person giving a low-friction cart a quick push to get it moving along a track. They then consider the clicker question shown in Figure 1. This question follows from Design Principle 1 (<em>Learning builds on prior knowledge</em>). The choices are based on students' common responses to similar, but open-ended questions in the SC version of
                        <em>Next Gen PET</em> and predecessor curricula, which suggested reasoning such as: the force is applied for only a very short time, after which the cart speeds up before starting to move with constant speed (choice A); the cart must speed up 'just a little' after the contact is finished (choice B); the force stops as soon as contact is lost (choice C); as long as the cart is in motion (even after contact is lost) it is influenced by the force of the hand, or the force is carried along as the cart moves (choice D). While the clickers provide quantitative information on students' responses, the instructor must interpret the results based on previous experience or knowledge of the literature on students' ideas on force and motion. The instructor resources provide relevant information and sample clicker response patterns.
                        </p>
                        <p class="text-center">
                        ...
                        <p>
                        Next, the materials include a movie of a low-friction cart being given three quick pushes as it moved along a track, with the speed-time graph displayed. In the corresponding SC activity, students generate the speed-time graph themselves. In the LC format, it is not feasible for students to conduct the experiment themselves, but including the movie supports the norm that arguments in science should be based on evidence (Design Principle 5:
                        <em>Learning is facilitated through establishment of norms</em>). The next clicker question asks the students to imagine what force-time graph would correspond to this speed-time graph, and choose from three possible graphs (see Fig. 2.). Again, the distractors are drawn from the developers' experience with the SC version and other curricula, and represent typical student responses. These include the idea that the force is transferred to the cart during each push, but that the force slowly runs out after the push (choice C); and the idea that whenever there is motion, there must be force, and that more speed means more force (choice B).
                        </p>
                        <p class="text-center">
                        ...
                        <em>According to the evidence from the graphs, did the force caused by the hand continue acting on the cart after it had lost contact with the cart? How do you know?</em> After students discuss the questions with their nearest neighbors, the instructor can call on students in the class to share their answers and reasoning with the whole class.
                        </p>
                        <p>
                        Part 2 of the POM section addresses the question of whether an object being in motion implies that a force is acting on it. Part 3 connects force and energy in terms of what is transferred during a contact interaction. The
                        <em>Summarizing Questions</em> section begins with a clicker question specifically about transfer, shown in Figure 3.
                        </p>
                        <p class="text-center">
                        ...
                        <em>Next Gen PET</em> incorporates the Design Principles. Students' prior knowledge is elicited through the first clicker question (supporting Design Principle 1), providing opportunities for students to engage in discussions (supporting Design Principle 4). Videos, clickers, and the student workbook are tools that facilitate learning and help structure interactions (Design Principle 3).
