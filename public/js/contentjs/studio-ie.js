...
var nodes = new vis.DataSet([{
    ...
    x: "-975",
    y: "-950",
    description: "In this engineering design activity, students apply what they had learned about the three methods for transferring energy due to temperature differences to design a solar shower that will collect water, heat it, and keep it warm until it can be used. The activity leads students through three simpler design challenges before they need to design the shower for the grand challenge. In each of these challenges, students need to either make a decision or analyze a system and then justify it in terms of what they had learned in Activity 4. First, they decide whether a clear plastic bag or a black plastic bag would be more effective in heating the water inside it. Second, they need to explain how a container with a clear glass top can both warm up water inside it and keep the water warm for long periods of time. Third, they decide what materials and color would be best for a two-tank system, where the purpose of the first tank it to collect and warm up water and the purpose of the second (and connected) tank is to keep water warm for long periods of time."
}, {
    id: 8,
...
var nodes2 = new vis.DataSet([{
    ...
    x: "-975",
    y: "-800",
    description: "This activity has students consider how they could store the kinetic energy lost when a vehicle brakes, and then recover it again afterward. They first consider how normal friction brakes function by transforming kinetic energy to thermal energy, which is then 'lost' as it is transferred to the surroundings. They then consider how some of the different interactions they have encountered in this module could be used to convert this kinetic energy to other forms that are more easily recovered, such as the kinetic energy of a flywheel or the deformation of an elastic object. Next, they brainstorm how electric circuit, magnetic, and gravitational interactions could also be used. Finally, they experiment with a generator and a capacitor to show that such a system could be used for both braking and recovery."
}, {
    id: 8,
    label: 'Ext A: More on\nElastic Energy',
    x: "-900",
