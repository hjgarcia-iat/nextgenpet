...
var nodes = new vis.DataSet([
    ...
    },
    {
        ...
        x          : "-850",
        y          : "-875",
        description: "This is the first engineering design activity in the curriculum. Students are presented with a brief description of the maglev (magnetic levitation) train system and are introduced to a brief description of the steps in the engineering design process. For this lesson, their challenge is to design and construct a simple ‘maglev-like’ system where an object can move a certain distance while floating above the surface. They explain how their model system works based on ideas from the unit. Following this, they consider two scenarios involving potential problems with a real maglev train and justify their response in terms of ideas developed during the unit."
    },
    {
        id         : 8,
...
var nodes2 = new vis.DataSet([
    ...
    },
    {
        ...
        x          : "-1025",
        y          : "-900",
        description: "Students first watch a movie of a fire ignited by a static electric spark while a vehicle is being refueled. They then consider safety instructions typically posted on gas pumps and use their model of static electricity to explain how not following them could result in a fire. They then consider the process of refueling a plane and develop a procedure and training that could be followed to ensure this is done safely. Finally, they consider i) how they might need to change their procedure for non-metal constructed planes and ii) design possible systems to achieve the discharge of a plane, in the event their procedure is not being followed."
    },
    {
        id         : 12,
        label      : 'Ext A: Which \nis Charge \nis Which?',
